...
| $S_T$ | 0.055 | - | Total mineral content fraction | Rothermel (1972) |
| $S_e$ | 0.01 | - | Effective (ite-free) mineral content | Rothermel (1972) |
...
$$
\beta_{op} = 3.348 \times \sigma^{-0.8189}
$$
...
where $r = M/M_{ex}$ (moisture ratio to extinction moisture).
...
The heat required to raise fuel to ignition temperature (BTU/lb). The constant 250 represents the sensible heat to raise dry fuel to ignition (~600°F), while 1116 accounts for the latent heat of vaporizing fuel moisture (Rothermel 1972, Eq. 12).
...
The fraction of a fuel particle that is heated to ignition temperature before the flame front passes. Smaller particles (higher SAV) heat more completely (Rothermel 1972, Eq. 14). The coefficient 138 was calibrated from experimental data.

### Slope Factor

$$
\phi_s = 5.275 \times \beta^{-0.3} \times \tan^2\theta
$$

The slope factor accounts for radiant heat transfer to upslope fuels. The coefficients 5.275 and -0.3 were derived from laboratory experiments on inclined fuel beds (Rothermel 1972, Eq. 52). The dependence on $\tan^2\theta$ reflects the geometric increase in view factor with slope angle.
